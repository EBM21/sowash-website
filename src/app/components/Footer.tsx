...
export default function Footer() {
  return (
    <footer className="bg-[#111] text-white pt-12 pb-6 relative">
      <div className="max-w-7xl mx-auto px-6 flex grid-cols-1 md:grid-cols-3 gap-10 justify-evenly">
      ...
      <div className="text-center mt-12 border-t border-gray-700 pt-6">
        <h4 className="text-lg font-semibold mb-2">Call Us Now</h4>
        <div className="flex justify-center items-center space-x-2 text-green-400 font-bold text-lg">
          <PhoneCall />
